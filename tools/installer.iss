; growforge Windows installer (Inno Setup 6).
;
; Compiled by tools\build_installer.ps1, which passes the version in:
;
;   ISCC.exe /DAppVersion=0.39.0 tools\installer.iss
;
...
Source: "..\examples\*.toml"; DestDir: "{app}\examples"; Flags: ignoreversion uninsremovereadonly; Attribs: readonly
...
Name: "{group}\growforge"; Filename: "{app}\growforge.exe"; Parameters: "edit"; WorkingDir: "{userdocs}"
Name: "{group}\{cm:UninstallProgram,growforge}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\growforge"; Filename: "{app}\growforge.exe"; Parameters: "edit"; WorkingDir: "{userdocs}"; Tasks: desktopicon
